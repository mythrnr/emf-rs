 ...
 * @returns {string}
 */
export function convertEmf2Svg(buf) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_export3);
        const len0 = WASM_VECTOR_LEN;
        wasm.convertEmf2Svg(retptr, ptr0, len0);
...
export function setLogLevel(level) {
    const ptr0 = passStringToWasm0(level, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('emf_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
