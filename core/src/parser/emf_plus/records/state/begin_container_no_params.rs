/// The EmfPlusBeginContainerNoParams record opens a new graphics state
/// container.
///
...
/// implementation.
#[derive(Clone, Debug)]
pub struct EmfPlusBeginContainerNoParams {
    /// Type (2 bytes): An unsigned integer that identifies this record
    /// type as EmfPlusBeginContainerNoParams from the RecordType
    /// enumeration. The value MUST be 0x4028.
    ...
    /// MUST be referenced by a subsequent EmfPlusEndContainer record to
    /// close the graphics state container.
    pub stack_index: u32,
}

impl EmfPlusBeginContainerNoParams {
    ...
    pub fn parse<R: crate::Read>(
        ...
        crate::parser::ParseError::expect_eq(
            "record_type",
            record_type as u16,
            crate::parser::emf_plus::RecordType::EmfPlusBeginContainerNoParams
                as u16,
        )?;
...
mod tests {
    ...
    fn parses_stack_index() {
        ...
        let record = EmfPlusBeginContainerNoParams::parse(
            &mut buf,
            crate::parser::emf_plus::RecordType::EmfPlusBeginContainerNoParams,
            0x0000,
        ...
        assert_eq!(record.stack_index, 3);
    }
    ...
    fn rejects_wrong_record_type() {
        ...
        assert!(
            EmfPlusBeginContainerNoParams::parse(
                &mut buf,
