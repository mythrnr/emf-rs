...
impl EMR_MASKBLT {
    ...
    pub fn parse<R: crate::Read>(
        ...
        let rop4 = read_with(buf, &mut size, ROP4::parse)?;
...
impl ROP4 {
    ...
    pub fn parse<R: crate::Read>(
        ...
        let reserved: [u8; 2] = read_array_field(buf, &mut consumed_bytes)?;
        let background_rop3 = read_field(buf, &mut consumed_bytes)?;
        let foreground_rop3 = read_field(buf, &mut consumed_bytes)?;
