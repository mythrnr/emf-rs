/// The EMR_SCALEVIEWPORTEXTEX record specifies the current viewport in the
/// playback device context by using ratios formed by the specified
...
/// ```
#[derive(Clone, Debug)]
pub struct EMR_SCALEVIEWPORTEXTEX {
    /// Type (4 bytes): An unsigned integer that identifies this record type as
    /// EMR_SCALEVIEWPORTEXTEX. This value is 0x0000001F.
    pub record_type: crate::parser::RecordType,
    /// Size (4 bytes): An unsigned integer that specifies the size of this
    /// record in bytes.
    pub size: crate::parser::Size,
    /// xNum (4 bytes): A signed integer that specifies the horizontal
    /// multiplicand. Cannot be zero.
    pub x_num: i32,
